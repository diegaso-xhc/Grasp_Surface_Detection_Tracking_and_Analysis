...
[yf_cell, yf_cell_nob, vert] = calculate_contacts(th, Y, ob, y_track); % Calculate the contact surfaces
...
figure;
h1Plot = plot3(NaN,NaN,NaN,'.', 'Color', [0.9290 0.6940 0.1250], 'MarkerSize', 0.1); % Hand plot
hold on
h2Plot = plot3(NaN,NaN,NaN, '.', 'Color', [0.32, 0.64, 0.74]); % Hand plot
h3Plot = plot3(NaN,NaN,NaN,'.k','MarkerSize',40); % Hand plot
h4Plot_ax = quiver3(NaN,NaN,NaN,NaN,NaN,NaN, 'b');
h5Plot = plot3(NaN,NaN,NaN,'.r', 'Color', [200 20 60]/255, 'MarkerSize',10); % Hand plot
