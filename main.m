...
betas = [7.4394211849484578, 1.5718488752572914, 0.4441326581811165, -3.184784177810678, -2.0533222423773667, -2.7747463926925033, 0.888224485138984, 1.7561999647492048, 4, 0.9774567444995015];
...
system(strcat('source /home/diegoubuntu/Documents/Ab_2022/Simulation/human_hand/my_venv/bin/activate && ', strcat('python ./Fit_MANO/opt_MANO_MoCap.py --sequencedata', strcat(" ./", name_data_to_py, '.mat'),... % Calls an optimization algorithm in Python which uses the MANO hand model and runs the previously                                                                                                         
